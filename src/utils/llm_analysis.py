...
def ask_llm(prompt: str, max_tokens: int = 200, return_json: bool = False) -> Optional[Union[str, Dict[str, Any]]]:
    """
...
def ask_llm_json(prompt: str, schema: Dict[str, Any], max_tokens: int = 1000) -> Optional[Dict[str, Any]]:
    """
    Ask LLM for structured JSON response following a schema.
    
    Args:
        prompt: Analysis request
        schema: Example of expected JSON structure
    ...
    return ask_llm(full_prompt, max_tokens=max_tokens, return_json=True)