...
def _apply_updates(
        existing_item: Dict[str, Any], updates: Dict[str, Any])-> Dict[str, Any]:
    """
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(
            "Failed to load artifact %s from DynamoDB: %s", artifact_id, exc, exc_info=True
        )
